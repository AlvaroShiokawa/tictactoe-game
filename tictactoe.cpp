...
TicTacToe::TicTacToe()
{
   free_spaces = new int;
   wongame = new int;
   player_made_a_correct_move = new int;
   gamearea = new char*[3];
   gamearea[0] = new char[3];
   gamearea[1] = new char[3];
   gamearea[2] = new char[3];
   cpu_level = "Retard";
   *wongame = 0;
   *free_spaces = 9;
...
TicTacToe::~TicTacToe()
{
   ...
   delete free_spaces;
   delete wongame;
   delete player_made_a_correct_move;
}
//
//
...
void TicTacToe::Game_Status()
{
   ...
   /*[ ][ ][X]
     ...
     [X][ ][ ]*/
      ...
      if ((end_of_game==false)&&((*free_spaces)
